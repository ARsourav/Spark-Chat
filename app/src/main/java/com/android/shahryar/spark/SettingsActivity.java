            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default")){
                    ...
                    /*Picasso.get().load(image).placeholder(R.drawable.default_avatar)
                            .networkPolicy(NetworkPolicy.OFFLINE).into(mDisplayImage, new Callback() {
                        @Override
            ...
            if (resultCode == RESULT_OK)
            {
                ...
                filepath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        ...
                        {
                            Toast.makeText(SettingsActivity.this, "Error encountered while updating profile picture", Toast.LENGTH_SHORT).show();
                            mProgressDialog.dismiss();
                        }
